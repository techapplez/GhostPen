...
pub(crate) fn main() {
    ...
    loop {
        if mode == "broadcast" {
            ...
            let mut ethernet_packet1 = MutableEthernetPacket::new(&mut ethernet_buffer1).unwrap();
            ...
            let mut ethernet_packet2 = MutableEthernetPacket::new(&mut ethernet_buffer2).unwrap();
