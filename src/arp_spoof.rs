use crate::{get_interface_input, ip_input, mac};
...
pub(crate) fn main() {
    ...
    loop {
        if mode == "broadcast" {
            ...
            let mut ethernet_packet1 = MutableEthernetPacket::new(&mut ethernet_buffer1)
            ...
            let mut ethernet_packet2 = MutableEthernetPacket::new(&mut ethernet_buffer2)
                .expect("Failed to create Ethernet packet");
